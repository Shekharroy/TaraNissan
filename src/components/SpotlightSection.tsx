...
export const SpotlightSection: React.FC<SpotlightSectionProps> = ({
  ...
  return (
    <section 
      ...
      className="py-16 sm:py-24 bg-[#f6f6f6] border-b border-[#e5e5e5]"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white border border-[#e5e5e5] p-8 flex flex-col justify-between hover:shadow-lg transition-all group">
            <div>
              <div className="w-12 h-12 rounded-full bg-red-50 text-[#c3002f] flex items-center justify-center mb-6">
              ...
              <h3 className="text-[22px] font-nissan-bold text-[#111111] mb-3">
                5-Star NCAP Crash Safety Standard
              </h3>
              <p className="text-[15px] text-[#555555] font-nissan-regular leading-relaxed mb-6">
              ...
              <div className="h-44 overflow-hidden mb-6 bg-[#fcfcfc] flex items-center justify-center border border-[#eeeeee]">
                <img
            ...
            <button
              ...
              className="text-[13px] font-nissan-bold text-[#111111] group-hover:text-[#c3002f] flex items-center gap-1.5 uppercase tracking-wider cursor-pointer"
            >
          ...
          <div className="bg-white border border-[#e5e5e5] p-8 flex flex-col justify-between hover:shadow-lg transition-all group">
            <div>
              <div className="w-12 h-12 rounded-full bg-neutral-100 text-[#111111] flex items-center justify-center mb-6">
