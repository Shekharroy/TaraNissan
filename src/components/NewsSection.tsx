...
export const NewsSection: React.FC = () => {
  return (
    <section 
      ...
      className="py-16 sm:py-20 bg-white border-b border-[#e5e5e5]"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            ...
            <h2 className="nissan-section-title text-[#111111]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {NEWS_ITEMS.map((item) => (
            <article
              key={item.id}
              className="border border-[#e5e5e5] bg-white flex flex-col justify-between group hover:border-black transition-colors"
            >
              <div>
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-[17px] font-nissan-bold text-[#111111] mb-3 leading-snug group-hover:text-[#c3002f] transition-colors">
                    {item.title}
                  </h3>
                  <p className="text-[14px] text-[#555555] font-nissan-regular leading-relaxed">
                    {item.summary}
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 pt-0">
                <span className="text-[12px] font-nissan-bold text-[#111111] group-hover:text-[#c3002f] uppercase tracking-wider inline-flex items-center gap-1">
